...
// 4. ленивое подключение поискового модуля.
//
...
// Поиск подключается отдельным ES-модулем. Query-параметр использует тот же
// revision, что и HTML/CSS, чтобы браузер не оставил старую версию модуля после
// публикации новой версии статического сайта.
import(`/js/search.js?v=${ASSET_REVISION}`)
