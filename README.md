...
- пока модуль поиска загружается, `main.js` временно перехватывает ранний shortcut и переигрывает его после инициализации, поэтому первое нажатие после загрузки страницы не теряется;
